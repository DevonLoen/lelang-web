          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
            <div>
              ...
              <div id="thumbnailContainer" className="grid grid-cols-5 gap-2">
                <img
                  src="https://placehold.co/600x400/e2e8f0/333?text=Jam+Tangan"
                  alt="Thumbnail 1"
                  className="thumbnail-active cursor-pointer w-full h-auto rounded-md border-2 object-cover aspect-square opacity-60 hover:opacity-100 transition"
                />
                <img
                  src="https://placehold.co/600x400/dbeafe/333?text=Detail+1"
                  alt="Thumbnail 2"
                  className="cursor-pointer w-full h-auto rounded-md border-2 border-transparent object-cover aspect-square opacity-60 hover:opacity-100 transition"
                />
                <img
                  src="https://placehold.co/600x400/bfdbfe/333?text=Detail+2"
                  alt="Thumbnail 3"
                  className="cursor-pointer w-full h-auto rounded-md border-2 border-transparent object-cover aspect-square opacity-60 hover:opacity-100 transition"
                />
                <img
                  src="https://placehold.co/600x400/fecaca/333?text=Detail+3"
                  alt="Thumbnail 4"
                  className="cursor-pointer w-full h-auto rounded-md border-2 border-transparent object-cover aspect-square opacity-60 hover:opacity-100 transition"
                />
              </div>
            ...
            <div className="flex flex-col">
              ...
              <div className="mt-8 border-t pt-6">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Ini adalah jam tangan antik warisan dari era 1950-an. Kondisi masih sangat baik dengan sedikit tanda pemakaian
                  yang wajar. Mesin otomatis berjalan dengan akurat. Tali kulit asli masih terpasang. Sebuah barang koleksi yang
                  langka dan berharga bagi para penggemar horologi.
                </p>
              </div>
