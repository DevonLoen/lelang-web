import type { ProductCondition, ProductStatus } from "../../../enums/product-enum";
    ...
    return (
        <div className="group bg-white rounded-xl shadow-lg overflow-hidden transition-all duration-300 hover:shadow-2xl hover:-translate-y-1">
            <div className="relative">
                ...
                <div className={`absolute top-2 right-2 text-xs font-semibold px-2.5 py-1 rounded-full capitalize ${statusStyles[status] || 'bg-gray-100 text-gray-800'}`}>
                    <span>{status}</span>
                </div>
            </div>
            <div className="p-5">
